...
$texts = [
    ...
    'kz' => [
        ...
        'login_link' => 'Аккаунт бар ма? Кіру',
        ...
        'invalid_email' => 'Email форматы қате',
        'username_too_short' => 'Пайдаланушы аты кемінде 3 таңба болуы керек',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        $message = $texts[$lang]['username_too_short'];
    } elseif (strlen($password) < 6) {
        $message = $texts[$lang]['password_too_short'];
    } elseif (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $message = $texts[$lang]['invalid_email'];
    } elseif ($password !== $confirm_password) {
        $message = $texts[$lang]['password_mismatch'];
    } else {
        ...
        if ($username_exists) {
            $message = $texts[$lang]['username_taken'];
        } elseif ($email_exists) {
            $message = $texts[$lang]['email_taken'];
        } else {
            ...
            $message = $texts[$lang]['registration_success'];
...
<head>
    ...
    <title>rusEFI — <?= $texts[$lang]['register_title'] ?></title>
        ...
        <div class="form-container">
            <form method="post">
                <div class="form-group">
                    <label for="username" class="form-label"><?= $texts[$lang]['username'] ?></label>
                    <input type="text" id="username" name="username" class="form-input" required>
                </div>

                <div class="form-group">
                    <label for="email" class="form-label"><?= $texts[$lang]['email'] ?></label>
                ...
                <div class="form-group">
                    <label for="confirm_password" class="form-label"><?= $texts[$lang]['confirm_password'] ?></label>
                    <input type="password" id="confirm_password" name="confirm_password" class="form-input" required>
                </div>

                <div class="form-actions">
                    <button type="submit" class="btn"><?= $texts[$lang]['register_btn'] ?></button>
                </div>
            </form>
        </div>

        <div class="links">
            <a href="login.php"><?= $texts[$lang]['login_link'] ?></a><br><br>
